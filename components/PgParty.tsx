     ...
     <>
        ...
        <div className="pb-12 overflow-y-scroll scrollbar-hide">
            <table className="w-full border-separate border-spacing-0 border border-green-300/20 rounded text-[0.86rem] text-green-200/80">
                <tr className="hidden md:grid md:grid-cols-6 bg-green-400/20 text-green-200 text-[0.86rem] font-inter font-medium tracking-wider">
                    <td className="px-6 py-3">Code</td>
                    <td className="px-6 py-3 md:col-span-2">Name</td>
                    <td className="px-6 py-3">Logo</td>
                    <td className="px-6 py-3">Ballot #</td>
                    <td className="px-6 py-3">&nbsp;</td>
                </tr>
                <tr className="grid grid-cols-1 md:grid-cols-6 text-left ">
                    ...
                    <td className="px-6 py-3 grid md:col-span-2 md:grid-cols-1 gap-y-2 md:border-b border-green-300/20">
                        ...
                        <span className="ml-3 md:m-0">NATIONAL DEMOCRATIC CONGRESS</span>
                    </td>
                    <td className="px-6 py-3 grid md:grid-cols-1 gap-y-2 md:border-b border-green-300/20">
                        <span className="md:hidden py-0.5 px-3 rounded bg-green-300/10">Logo</span>
                        <span className="ml-3 md:m-0">
                            <Image className="p-0.5 h-10 w-10 rounded bg-white object-contain" src={Logo} alt="Logo" />
                        </span>
                    </td>
                    <td className="px-6 py-3 grid md:grid-cols-1 gap-y-2 md:border-b border-green-300/20">
                        <span className="md:hidden py-0.5 px-3 rounded bg-green-300/10">Ballot #</span>
                        <span className="ml-3 md:m-0"># 1</span>
                    </td>

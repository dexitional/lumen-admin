     ...
     <>
        ...
        <div className="pb-12 overflow-y-scroll scrollbar-hide">
            <table className="w-full border-separate border-spacing-0 border border-green-300/20 rounded text-[0.86rem] text-green-200/80">
                <tr className="hidden md:grid md:grid-cols-8 bg-green-400/20 text-green-200 text-[0.86rem] font-inter font-medium tracking-wider">
                    <td className="px-6 py-3">Party</td>
                    <td className="px-6 py-3 md:col-span-2">Name</td>
                    <td className="px-6 py-3">Sex</td>
                    <td className="px-6 py-3">Age</td>
                    <td className="px-6 py-3 md:col-span-2">Constituency</td>
                    <td className="px-6 py-3">&nbsp;</td>
                </tr>
                <tr className="grid grid-cols-1 md:grid-cols-8 text-left ">
                    <td className="px-6 py-3 grid md:grid-cols-1 gap-y-2 md:border-b border-green-300/20">
                        <span className="md:hidden py-0.5 px-3 rounded bg-green-300/10">Party</span>
                        <span className="ml-3 md:m-0">NDC</span>
                    </td>
                    <td className="px-6 py-3 grid  md:col-span-2 md:grid-cols-1 gap-y-2 md:border-b border-green-300/20">
                        ...
                        <span className="ml-3 md:m-0">EBENEZER KWABENA BLAY ACKAH</span>
                    </td>
                    <td className="px-6 py-3 grid md:grid-cols-1 gap-y-2 md:border-b border-green-300/20">
                        <span className="md:hidden py-0.5 px-3 rounded bg-green-300/10">Sex</span>
                        <span className="ml-3 md:m-0">M</span>
                    </td>
                    <td className="px-6 py-3 grid md:grid-cols-1 gap-y-2 md:border-b border-green-300/20">
                        <span className="md:hidden py-0.5 px-3 rounded bg-green-300/10">Age</span>
                        <span className="ml-3 md:m-0">35</span>
                    </td>
                    <td className="px-6 py-3 grid  md:col-span-2 md:grid-cols-1 gap-y-2 md:border-b border-green-300/20">
